  ...
  return (
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 bg-backgroundColor ">
      ...
      <div className=" flex flex-col lg:flex-row gap-5 justify-center py-4 my-8">
        <Devs img={img1} title="piyush"  desc="Hello! I'm piyush, and I contributed to this project. I used React and Tailwind, and we achieved the best UI through Shweta, who made excellent color selections to get this amazing output." />
